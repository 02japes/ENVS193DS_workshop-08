...
shoot mass (units: g): mass of above-ground tissue
...
**Root mass is strongly positively correlated with SLA with Pearson's coeff. being 0.46.**

**Shoot mass and Total Mass are strongly positively correlated with Pearson's coeff. being 0.902**

**SLA and Leaf Dry Weight are not as stongly correlated with a more random dot distribution and a Pearson's coeff. of 0.033**
...
**total biomass trends downward as we move through our list of observed plants. Some species have widely varying biomass as compared to others that have relatively similar biomass. Gumweed, CA Poppy, and Purple Needlegrass seem to have the largest biomass. Deerweed, Scarlet bugler, and purple sage seem to have the lowest biomass.**
...
**Well watered plants seem to display a higher mean total biomass as compared to drought stressed plants**
...
**specific leaf area seems to have a loose positive correlation with total biomass**

# Model construction

What is the null model?

0.  **total biomass is a function of NONE of the predictors**
...
**Delta value for the best model is ALWAYS 0.00**

Out of the four models we have tried, the best model is the one that includes **SLA, water treatment, and species (saturated model)**

Note that this may change once you fit and compare the other model!

**DOUBLE CHECK DIAGNOSTIC**
...
**reference for species_name:** **Deerweed (Acmispon glabier**

Interpret the model estimates for the:

-   intercept: **mass of reference (Acmispon glaber) in drought stressed water treatment when SLA equals zero**\
-   SLA slope: **For each 1 unit increase in SLA (mm^2^/g), you expect a decrease in plant mass of 0.0002 +- (display plus/minus in doc) 0.0005, SO NO EFFECT ON MASS**\
-   well watered estimate: **on average across species and SLA, well watered plants tend to be 0.12 +- 0.02g heavier than drought stressed plants**\
